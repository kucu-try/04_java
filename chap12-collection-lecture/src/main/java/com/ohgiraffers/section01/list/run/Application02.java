...
public class Application02 {
    public static void main(String[] args){
        ...
        /*
        * Comparato 인터페이스를 상속받아 정렬의 기준을 정해준 뒤 list 의 default 메소드인 sort() 메소드의 인자로
...
//        });
        ...
        System.out.println("==============================");
        bookList.sort((BookDTO b1, BookDTO b2) -> b2.getTitle().compareTo(b1.getTitle())); //람다식 / 축약 위의 옹버라이드의 축약
        for (BookDTO book : bookList) {
            System.out.println(book);
        }
    }
