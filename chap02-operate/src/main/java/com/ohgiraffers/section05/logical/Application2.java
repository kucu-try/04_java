...
public class Application2 {
    public static void main(String[] args) {
        ...
        * && : 11순위
        * ||: 12순위
        * 논리 and 연산자 우선순위가 논리 or 연산자 보다 우선 순위가 높다
        * */
        ...
        /*
        * 연산자 우선 순위를 고려한다면 논리 and 연산이 먼저 수행되기 떄문에 괄호는 넣지 않아도 된다
        * 하지만 연산자 우선순위를 디테일하게 학습하고 개발하는 개발자가 적은 현실로 논리적으로
        * 먼저 실행하는 내요을 괄호로 묶어주는게 좋다
        * */
