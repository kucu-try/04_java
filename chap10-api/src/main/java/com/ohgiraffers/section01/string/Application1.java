...
public class Application1 {
    public static void main(String[] args) {
        ...
        * 인덱스를 벗어난 경우 IndexOutofBoundException이 발생된다
        * */
        ...
        * */
        ...
        System.out.println("소문자와 대문자를 비교 compareTo() " +(java2.compareTo(java3)));
        ...
        * */
        ...
        String trimStr = "   java  ";
        System.out.println("trimstt : #" + trimStr + "#");
        ...
        * */
        String valuse = "java";
        System.out.println("toUpperCase " + valuse.toUpperCase());
        System.out.println(valuse);
        System.out.println("toLowerCase " +valuse.toLowerCase());
        System.out.println(valuse);
        ...
        * */
        ...
        /*
        * replace() : 문자열에서 대체할 문자열을 기준의 문자열을 변경해서 반환한다
        * */
        ...
        * */
        ...
        /*
        * isEmpty() : 문자열의 길이가 0이면 true 를 반환하고, 아니면 false를 반환한다.
...
//        System.out.println("nullTest" + nullTest.isEmpty());
        ...
        * */
        ...
        /*
        stack test = "java" 와 같은 리터럴 타입의 문자열은
