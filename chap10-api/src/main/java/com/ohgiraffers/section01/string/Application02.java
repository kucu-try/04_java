...
public class Application02 {
    public static void main(String[] args) {
        ...
        *           정규표현식은 자바에서 다루지 않고 자바스크립트에서 다룰 예정
        ...
        * */
        ...
        /*
        * 마지막 구분자 사이에 값이 존재하지 않는 경우 이후에 값도 추출하고 싶을 떄
        * 몊 개의 토큰으로 분리할 것인지 한계치를 두 번 째 인자로 넣을 수 있다.
        * */
        System.out.println("=============");
        String[] arrArr3 = emp1.split("/",-1);
        int i = 0;
        for (String emp : arrArr3) {
            System.out.println(i+ "번 째 인덱스 "+emp);
            i++;
        }
