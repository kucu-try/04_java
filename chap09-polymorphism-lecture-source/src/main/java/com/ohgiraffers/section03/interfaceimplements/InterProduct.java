...
public interface InterProduct extends Serializable {
    /*
    * 인터페이스가 인터페이스를 상속받을 시에는 extends 키워드를 이요하며
    * 이 때는 여러 인터 페이스를 다중 상속 받을 수 있다.
    * */
    ...
    * */
    ...
    int MIN_NUM = 10;
        ...
        //인터페이스는 생성자를 가질 수 없다.
    //인터페이스를 사용하는 목적은 추상 메서드를 묶어서 제공하기위함이다.
    //그렇기 때문에 INTERFACE를 생성하여 사용하는 일이 없이 어딘가에 상속하여 구현 후 사용하게 된다.
    //public InterProduct(){}

    // 추상 메서드는 몸체를 갖지 않기 떄문에 오류가 발생한다.
    //public abstract void nonStaticMethod(){}

    public abstract void nonStaticMethod();

    /*
    * 인터 페이스 안에 작성한 메서드는 묵시적으로 public abstract의 의미를 가진다. (다른 접근제한자 사용불가)
    ...
    * */
    ...
    public static void staticMethod(){
        System.out.println("InterProduct 클래스의 statci method 호출");
    }

    // default 키워드를 이용하여 작성하는 경우 가능하다. (jdk 1.8 추가된 기능)
    public default void defaultMethod(){
        System.out.println("InterProduct 클래스의 default 메서드 호출함");
    }
}
