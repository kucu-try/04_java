...
//        B_ifElseIf else1 = new B_ifElseIf();
//
//        System.out.println("어는 도끼가 너의 도끼이냐? (1.금도끼 2.은도끼. 3. 쇠도끼)");
//        int q1 = sc.nextInt();
        //금도끼를 선택한 경우
        // System.out.println("이런 거짓말 쟁이!! 너에게는 아무런 도끼도 줄수없다!");
        ...
        B_ifElseIf else1 = new B_ifElseIf();
        else1.testNestedIfElseIfStatement();
    }
    ...
    public void improveNestedIfElseStatement(
