...
public class Application02 {
    public static void main(String[] args){
        ...
        * */
         ...
         * 예) 앞에서 사용한 inT 자료형은 정수 4바이트 만큼을 읽어서 하나의 값으로 취급하겠다는 약조이다.
        ...
        // 1bit 는 0과 1 둘 중 하나의 값만을 가질 수 있는 데이터의 최소 단위이다.]
        ...
        * 문자를 취급하는 자료형은 한가지 이다.*/
        ...
        //논리 데이터 형은 0과 1의 값으로 데이터를 취급하기 떄문에 1bit 로 표현이 가능하지만 최소단위가 1byte 이기 때문에 1byte 크기를 갖는다
        boolean isTrue; //1byte

        System.out.println("========변수 초기화============");

        // 기본 자료형이 아니다! 참조 자료형이다 string
        String str;

        /*목차. 2. 변수에 값을 대입하기
        * 위에서 한 변수 선언은 메모리에 값을 저장하기 위해 공간만 생성해 둔 상태이다
        * 그 공간에 대입 연산자를 이용하여 자료형에 한 형태의 값을 지정할 수 있다
        ...
        * 변수를ㄹ 대입연산자 왼쪽에 사용하면 공간의 의미이고, 대입연산자 오른쪽에 사용하면 변수가 가진 값을 의미한다
        *
