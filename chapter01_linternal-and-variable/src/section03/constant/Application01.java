...
public class Application01 {
    ...
    public static void main(String[] args){
        ...
        /*상수란?
        * 변수가 메모리에 변경될 값을 저장하기 위한 공간을 나타낸다면 ㅡ 상수는 이와 상번되는 개념이다
        ...
        * 암묵적인 개발자 들의 규칙으로 상수는 일반 변수와 구분하기 위해 대문자로 작성한다!*/
        final int AGE;

        //상수 필드 초기화
        AGE = 10;
  //      AGE = 30;//초기화 이후 상수의 값은 변경할 수 없기 떄문에 에러가 발생한다
        System.out.println("Age의 값 :" + AGE);
        //필요시 연산식에 호출해서 사용가능하다
