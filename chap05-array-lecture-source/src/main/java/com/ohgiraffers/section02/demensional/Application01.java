...
public class Application01 {
    public static void main(String[] args) {
        ...
        * 즉 , 2 차원 배열은 1차원 배열 여러 개를 하나로 묶어서 관리하는 배열을 의미한다
        * 더 많은 차원의 배열을 사용할 수 있지만 일반적으로 2차원 배열 보다 더 높은 차원의 배열은 사용빈도가 적다
        *
        * */
        ...
        * 3.각 인덱스에서 관리하는 배열을 (heap)할당하여 주소를 보관하는 배열에 저장
        ...
        * 배열의 주소를 관리하는 배열의 길이는 앞 부분에 정수형으로 표기하며 반드시 크기를 지정해줘야한다.
        * */
        iarr1 = new int[3][];
//        iarr2 = new int[][4]; 오류
//        iarr3 = new int[][]; 오류
